...
#####################
#3.3 Unfold r_df_by_state to one long list r_df_allstates and save this to pickle
#####################
...
# Join on indexes
df_n_z_score_all_states=pd.merge(r_df_all_states_pivot_all_columns['z_score'],n_df_us,how='left',left_index=True, right_index=True) 
...
#####################
#3.5 Save dataframe with r-values, populations and weighted abs z-score to pickle
#####################

print 'Starting saving of df_n_z_score_all_states to pickle'
foldername ='/Users/maarten/Desktop/nyu-data/NHGIS/us/'
filename= '%s_censustracts_us_2015/%s_censustracts_us_2015_pickle_n_r_weighted_z_nullmodel_perstate.pkl' %(parameter,parameter)
picklename=foldername+filename
...
for class_id in class_id_list:
        for class_id2 in class_id_list:
            exp_dict[class_id][class_id2]=calc_exposure(r_df,df_us,'area_id','GISJOIN',class_id,class_id2)
print 'Ended calculation of exposure values based on Maartens implementation'
...
############################
#6.  Calculate exposure values for each state data based on null model for each state. 
############################
